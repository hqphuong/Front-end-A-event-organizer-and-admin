...
export const EventDetailLayout = () => {
  ...
  const [event, setEvent] = useState(null); // 4. State để lưu thông tin sự kiện
  
  const [isMenuOpen, setIsMenuOpen] = useState(false);

  // 5. Tự động lấy tên sự kiện khi trang tải
  useEffect(() => {
    ...
    <div className="bg-[#d9d9d9] overflow-hidden border border-solid border-[#d9d9d9] w-full min-w-[1440px] min-h-[1905px] relative">
     ...
     {/* Sidebar và Header */}
      ...
      <div className="absolute top-[29px] left-[306px] w-[203px] [font-family:font-poppins font-extrabold,Helvetica] font-black italic text-[#f94f2f] text-xl text-center tracking-[0] leading-[normal] z-[10]">
        {/* Thay vì "SỰ KIỆN CỦA TÔI", dùng tên sự kiện */}
...
{/* Nút Tổng quan */}
      <div 
        onClick={() => navigate(`/event/${eventId}/overview`)}
      ...
      <div 
        onClick={() => navigate(`/event/${eventId}/orders`)} 
